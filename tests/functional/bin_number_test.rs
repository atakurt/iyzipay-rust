...
fn should_retrieve_bin() {
    ...
    assert_eq!(Some(&String::from("123456789")), bin_number.conversation_id());
    ...
    assert_eq!(Some(&String::from("MASTER_CARD")), bin_number.card_association());
    assert_eq!(Some(&String::from("Bonus")), bin_number.card_family());
    assert_eq!(Some(&String::from("Garanti Bankası")), bin_number.bank_name());
