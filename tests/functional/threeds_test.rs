...
fn should_create_payment_with_physical_and_virtual_item_for_standard_merchant() {
    ...
    let create_payment_request = CreatePaymentRequestBuilder::create()
        ...
        .build();
    let threeds_initialize = ThreedsInitialize::create(&create_payment_request, &get_test_options()).unwrap();
...
fn should_create_threeds_payment_with_physical_and_virtual_item_for_marketplace_merchant() {
    ...
    let sub_merchant = SubMerchant::create(&create_sub_merchant_request, &get_test_options()).unwrap();
...
fn should_auth_threeds() {
    ...
    let threeds_payment = ThreedsPayment::create(&create_threeds_payment_request, &get_test_options()).unwrap();
