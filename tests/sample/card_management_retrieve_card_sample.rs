...
fn should_retrieve_card_management_page_cards() {
    ...
    let mut retrieve_card_management_page_card_request = RetrieveCardManagementPageCardRequest::new();
    ...
    let card_management_page_card = CardManagementPageCard::retrieve(&retrieve_card_management_page_card_request, &get_test_options()).unwrap();
