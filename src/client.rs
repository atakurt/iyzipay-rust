...
impl HttpClient {
    ...
    fn get_default_headers() -> HeaderMap {
        ...
        header_map.insert(header::CONTENT_TYPE, header::HeaderValue::from_static(APPLICATION_JSON));
        header_map.insert(header::ACCEPT, header::HeaderValue::from_static(APPLICATION_JSON));
        header_map
    }
}